        ...
        if (input.builtinModify) {
          ...
          if (result.success) {
            return {
              ...
              mode: 'builtin-pr',
              toolName: input.name,
              lifecycleRunId: result.lifecycleRunId ?? null,
              ...
              rollbackStatus: result.rollbackStatus ?? null,
              rollbackReason: result.rollbackReason ?? null,
              rollbackTargetBaselineSha: result.rollbackTargetBaselineSha ?? null,
              rollbackRunId: result.rollbackRunId ?? null,
